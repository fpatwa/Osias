...
[image]
image_path = http://download.cirros-cloud.net/0.5.1/cirros-0.5.1-x86_64-disk.img
http_image = http://download.cirros-cloud.net/0.5.1/cirros-0.5.1-x86_64-disk.img
